...
- ABC-анализ: Выделил ТОП-16 категорий, приносящих 80% выручки.
...
- Провёл аналитику по активности пользователей в разные временные промежутки разных дней недели (user_activity_by_daytime_analysis.sql)
